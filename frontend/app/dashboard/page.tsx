      ...
      <header className="border-b border-slate-200 bg-white sticky top-0 z-50 px-6 py-4 flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold bg-white hover:bg-rose-50 active:bg-rose-100 text-rose-650 border border-slate-200 hover:border-rose-200 shadow-sm transition cursor-pointer"
          >
          ...
          <button
            onClick={() => {
              router.push("/newdoctypes");
            }}
            className="flex items-center gap-2 py-1.5 px-3.5 rounded-lg font-bold text-xs bg-white hover:bg-slate-50 active:bg-slate-100 text-slate-700 border border-slate-200 shadow-sm transition disabled:opacity-50"
          >
            <FilePenLine className="h-3.5 w-3.5" />
            Creating of New DocTypes
          </button>

          <button
            onClick={() => {
              router.push("/warehouse-check");
            }}
            className="flex items-center gap-2 py-1.5 px-3.5 rounded-lg font-bold text-xs bg-white hover:bg-slate-50 active:bg-slate-100 text-slate-700 border border-slate-200 shadow-sm transition disabled:opacity-50"
          >
